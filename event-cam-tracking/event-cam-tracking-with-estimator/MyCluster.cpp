...
void MyCluster::setMuPrev(const Eigen::VectorXd& muPrev){
    muPrev_ = muPrev;
    // std::cout << "in setter function muPrev_ : " << muPrev_ << std::endl;
}

void MyCluster::setClusterId(int clusterId){
...
Eigen::VectorXd MyCluster::getMuPrev(){
    // std::cout << "from cluster getter function muPrev_ : " << muPrev_ << std::endl;
    Eigen::VectorXd muPrev(2);
    muPrev[0] = muPrev_[0];
    muPrev[1] = muPrev_[1];
    return muPrev;
}
